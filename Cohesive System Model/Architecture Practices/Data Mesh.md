...
Data Mesh can be expressed as ownership and projection-model boundaries:

- Domain teams own data products as boundary-scoped observations or projection models.
