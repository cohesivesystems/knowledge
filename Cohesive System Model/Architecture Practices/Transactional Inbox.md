...
Related concepts: [[Enterprise Integration Patterns|enterprise integration patterns]], [[Transactional Outbox|transactional outbox]], [[Outbox|outbox]], [[Idempotency|idempotency]], [[Delivery Semantics|delivery semantics]], [[Acknowledgments|acknowledgments]], [[Commit Boundaries|commit boundaries]], [[Effect Models|effects]], [[Recovery|recovery]], [[Retry|retry]], [[Interaction|interaction]], [[Consumer Coordination|consumer coordination]], [[Dual-Write Problem|dual-write problem]], [[Weak Isolation Patterns|weak isolation patterns]].
