...
The practice is about [[Flows|flows]] between [[Observer|observers]] through [[Event|events]]. Its central Cohesive questions are:
...
Related concepts: [[Event|event]], [[Observer|observer]], [[Flows|flows]], [[Interaction|interaction]], [[Delivery Semantics|delivery semantics]], [[Ordering|ordering]], [[Brokers|brokers]], [[Trace and Feedback|trace and feedback]], [[Event-State Duality|event-state duality]].
