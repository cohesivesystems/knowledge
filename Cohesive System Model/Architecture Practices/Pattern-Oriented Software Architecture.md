...
| Event demultiplexing and dispatch | Reactor, Proactor, Acceptor-Connector, Asynchronous Completion Token | [[Interaction Control Flow|interaction control flow]], correlation, scheduling, network, and runtime realization |
