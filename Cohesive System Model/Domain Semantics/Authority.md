...
Related concepts: [[Observer|observer]], [[Identity|identity]], [[Policy|policy]], [[Command|command]], [[Query|query]], [[Transition|transition]], [[Invariant|invariant]], [[Boundaries|boundaries]], [[Policy Scopes|policy scopes]], [[Effect Models|effects]], [[Scheduling|scheduling]], [[Arbitration|arbitration]], [[Nondeterminism and Choice|nondeterminism and choice]], [[Consensus|consensus]], [[Coordination|coordination]], [[Consistency Models|consistency models]], [[Persistence|persistence]], [[Realization|realization]].
