...
When the emitter expects a later response, the emission may be modeled as a [[Effects|request effect]]. The request effect belongs to the emitter's intent and continuation; command interpretation belongs to the receiving observer. Neither relation requires synchronous interaction.
