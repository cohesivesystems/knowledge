...
WAL [[Realization|realizes]] [[Persistence]], [[Reconstitution]], and [[Recovery]] for a storage or transaction boundary. It supports [[ACID|ACID]] durability and atomicity by making the recovery history more authoritative than any one cached page, memory image, or interrupted write.
