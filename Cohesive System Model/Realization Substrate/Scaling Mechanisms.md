...
They include changing resource allocations, adding or removing execution units, replicating functions or data, decomposing responsibilities, partitioning work, redistributing ownership, and controlling these changes automatically. A mechanism changes a realization; it does not prove that useful capacity increased or that semantic and operational guarantees were preserved.
...
Related concepts: [[Stuff Structure Property|stuff structure property]], [[Compositionality|compositionality]], [[Scalability|scalability]], [[Capacity Planning|capacity planning]], [[Control Theory|control theory]], [[Control Models|control models]], [[Additive Increase Multiplicative Decrease|AIMD]], [[PID Control|PID control]], [[Admission Control and Load Shedding|admission control and load shedding]], [[Locality|locality]], [[Metastability|metastability]], [[Trace and Feedback|trace and feedback]], [[Synchrony and Asynchrony|synchrony and asynchrony]], [[Realization|realization]], [[Compute|compute]], [[Infrastructure|infrastructure]], [[Infrastructure Graph|infrastructure graph]], [[System Graph|system graph]], [[Service Models|service models]], [[Interfaces|interfaces]], [[Interaction Protocols|interaction protocols]], [[Interaction|interaction]], [[Interaction Channels|interaction channels]], [[Routing Models|routing models]], [[Multiplexing and Demultiplexing|multiplexing and demultiplexing]], [[Consumer Coordination|consumer coordination]], [[Boundaries|boundaries]], [[Policy Scopes|policy scopes]], [[Identity|identity]], [[Authority|authority]], [[Delivery Semantics|delivery semantics]], [[Acknowledgments|acknowledgments]], [[Commit Boundaries|commit boundaries]], [[Ordering|ordering]], [[Idempotency|idempotency]], [[Persistence|persistence]], [[Durability|durability]], [[Reconstitution|reconstitution]], [[Compatibility and Evolution|compatibility and evolution]], [[Microservices|microservices]], [[Modular Monolith|modular monolith]], [[Asynchronous Interaction Design|asynchronous interaction design]], [[Operational Control|operational control]], [[Observability and Provenance|observability and provenance]], [[Scheduling|scheduling]], [[Fairness|fairness]], [[Arbitration|arbitration]], [[Rate Limiting|rate limiting]], [[Flow Control|flow control]], [[Coordination|coordination]], [[Concurrency Control|concurrency control]], [[Consensus|consensus]], [[CRDTs]], [[Recovery|recovery]], [[Retry|retry]], [[Runtimes|runtimes]], [[Application Hosts|application hosts]], [[Storage Systems|storage systems]], [[Brokers|brokers]], [[Network|network]].
