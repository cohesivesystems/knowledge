...
Related concepts: [[Durability|durability]], [[Durable Execution|durable execution]], [[Workflow Engines|workflow engines]], [[Process Managers|process managers]], [[Sagas|sagas]], [[Realization|realization]], [[Runtimes|runtimes]], [[Process Graphs|process graphs]], [[Process|process]], [[Observer|observer]], [[Coordination|coordination]], [[Persistence|persistence]], [[Reconstitution|reconstitution]], [[Recovery|recovery]], [[Retry|retry]], [[Idempotency|idempotency]], [[Ordering|ordering]].
