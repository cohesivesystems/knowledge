...
- A family of entity-state [[Observation|observations]] across time, indexed by [[Version]].
...
Under the [[Stuff Structure Property]] lens, an entity is primarily stuff: an identifiable subject. Its transitions, state history, relations, and emitted events provide structure; its invariants and policies express properties that valid evolution must satisfy.
...
An entity is not automatically an [[Observer]], but it may be modeled or realized as one when it interprets inputs relative to its own state, version history, invariants, policies, and boundary. Actor-hosted entities, entity command handlers, and long-running process entities are common examples.
...
Related concepts: [[Value]], [[Shape]], [[State]], [[Identity]], [[Version]], [[Observer]], [[Boundaries]], [[Transition]], [[Command]], [[Event]], [[Entity Models]], [[Stuff Structure Property]], [[Realization]], [[Concurrency Control]], [[Actor Systems]].
