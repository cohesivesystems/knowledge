...
As an architecture practice, these patterns are discussed in [[Cohesive System Model/Architecture Practices/Weak Isolation Patterns|weak isolation patterns as architecture practice]].
...
Common hazard shapes that motivate these patterns are cataloged in [[Distributed Failure Scenarios|distributed failure scenarios]].
...
- **[[Sagas|Sagas]] and [[Process Managers|process managers]]**: decompose long-running work into steps with explicit recovery, compensation, or forward progress.
...
Related concepts: [[Cohesive System Model/Architecture Practices/Weak Isolation Patterns|weak isolation patterns as architecture practice]], [[Distributed Failure Scenarios|distributed failure scenarios]], [[ACID]], [[Two-Phase Commit|two-phase commit]], [[Isolation|isolation]], [[Coordination|coordination]], [[Orchestration and Choreography|orchestration and choreography]], [[Process Managers|process managers]], [[Sagas|sagas]], [[CALM Theorem|CALM theorem]], [[Concurrency Control|concurrency control]], [[Consistency Models|consistency models]], [[Commit Boundaries|commit boundaries]], [[Effects|effects]], [[Ordering|ordering]], [[Idempotency|idempotency]], [[Retry|retry]], [[Recovery|recovery]], [[Durable Execution|durable execution]], [[Transactional Outbox|transactional outbox]], [[Outbox|outbox]], [[Transactional Inbox|transactional inbox]], [[Dual-Write Problem|dual-write problem]], [[CRDTs]], [[Invariant|invariants]], [[Business Transactions|business transactions]].
