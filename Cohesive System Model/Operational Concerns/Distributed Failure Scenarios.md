...
Distributed failure scenarios are recurring hazard shapes that appear when [[Effect Models|effects]], [[Observation|observations]], [[Commit Boundaries|commit boundaries]], [[Durability|durability]], [[Isolation|isolation]], [[Coordination|coordination]], and [[Recovery|recovery]] cross independently governed boundaries.
