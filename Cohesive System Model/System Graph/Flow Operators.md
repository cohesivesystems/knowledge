...
Related concepts: [[Enterprise Integration Patterns|enterprise integration patterns]], [[Flow Views|flow views]], [[Process Graphs|process graphs]], [[Transition Models|transition models]], [[Routing Models|routing models]], [[Messages and Envelopes|messages and envelopes]], [[Interaction Channels|interaction channels]], [[Interaction Control Flow|interaction control flow]], [[Shape|shape]], [[Observation|observation]], [[Correlation and Conversations|correlation and conversations]], [[Ordering|ordering]], [[Consistent Cuts|consistent cuts]], [[Compositionality|compositionality]].
