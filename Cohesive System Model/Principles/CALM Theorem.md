...
Related concepts: [[Coordination|coordination]], [[Consistency Models|consistency models]], [[Safety and Liveness|safety and liveness]], [[Asynchronous Computability Theorem|asynchronous computability theorem]], [[Ordering|ordering]], [[Delivery Semantics|delivery semantics]], [[Weak Isolation Patterns|weak isolation patterns]], [[CRDTs]], [[Invariants|invariants]], [[Projections|projections]], [[Observation|observation]], [[Compositionality|compositionality]], [[Universal Constructions|universal constructions]].
