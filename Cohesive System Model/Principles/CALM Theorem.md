...
- [[Cohesive System Model/Operational Concerns/Weak Isolation Patterns]] often work by making non-monotonicity explicit through versions, reservations, pending states, compensation, reconciliation, or scoped coordination.
...
Related concepts: [[Coordination|coordination]], [[Consistency Models|consistency models]], [[Safety and Liveness|safety and liveness]], [[Asynchronous Computability Theorem|asynchronous computability theorem]], [[Ordering|ordering]], [[Delivery Semantics|delivery semantics]], [[Cohesive System Model/Operational Concerns/Weak Isolation Patterns|weak isolation patterns]], [[CRDTs]], [[Invariant|invariants]], [[Projection Models|projection models]], [[Observation|observation]], [[Compositionality|compositionality]], [[Universal Constructions|universal constructions]].
