...
- [[Event-State Duality]]: event schedules and state histories are dual views of [[Behavior]], but they are not interchangeable representations.
...
- [[Persistence]] and [[Reconstitution]]: one makes material durable; the other turns durable material back into usable observations.
...
Symmetry is often broken by boundaries, observers, time, authority, or commitment. For example, input and output appear symmetric as interaction roles, but a receiving [[Observer]] may reject, reinterpret, or ignore an incoming event. Persistence and reconstitution appear symmetric as write/read roles, but persistence choices determine which histories, observations, and versions can actually be reconstituted.
...
Related concepts: [[Event-State Duality]], [[Event]], [[State]], [[Behavior]], [[Observer]], [[Boundaries]], [[Persistence]], [[Reconstitution]], [[Interaction]], [[Concurrency Control]].
